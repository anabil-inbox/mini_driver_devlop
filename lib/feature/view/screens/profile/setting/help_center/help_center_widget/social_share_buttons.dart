...
//       children: [
//         if(SharedPref.instance.getAppSettings()?. != null && SharedPref.instance.getAppSettings()!.socialContact!.isNotEmpty)
//         SizedBox(
//           height: 60,
...
//               var socialContact = SharedPref.instance.getAppSettingsء()?.socialContact![index];
//               return InkWell(
//                 onTap: () {
